...
\vspace{0pt}
\fbox{\includegraphics[width=.95\textwidth]{InesDrescher.jpg}}
\end{minipage}
\hfill
...
\singlespacing
\Large{Trainerin}\\
\huge{\textbf{Ines Drescher}} \par
\flushright
\normalsize{\textit{\textrm{``Im Kopf muss immer etwas Platz bleiben - für die Flausen und Fantasie''}}}
\end{minipage}
%\end{figure}
