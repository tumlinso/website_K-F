...
\vspace{0pt}
\fbox{\includegraphics[width=.95\textwidth]{JoMittermeier.jpg}}
\end{minipage}
\hfill
...
\singlespacing
\Large{Trainer}\\
\huge{\textbf{Jo Mittermeier}} \par
\flushright
\normalsize{\textit{\textrm{``Wenn du etwas erreichen möchtest, was du noch nie geschafft hast, musst du etwas tun, was du noch nie gemacht hast.''}}}
\end{minipage}
%\end{figure}
...
\vspace{0pt}
\onehalfspacing
Fitnesstrainer C-Lizenz in Ausbildung\\ (BGKV)
\end{minipage}
