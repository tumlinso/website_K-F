...
\vspace{0pt}
\fbox{\includegraphics[width=.95\textwidth]{LaurenzSchneider.jpg}}
\end{minipage}
\hfill
...
\singlespacing
\Large{Trainer}\\
\huge{\textbf{Laurenz Schneider}} \par
\flushright
\normalsize{\textit{\textrm{``Whatever It Takes''}}}
\end{minipage}
%\end{figure}
...
\vspace{0pt}
\onehalfspacing
Deutscher U18 Vizemeister 2017 (GNBF) \\
Int. Österr. U18 Vizemeister 2017 (ANBF) 
\end{minipage}
