...
\vspace{0pt}
\fbox{\includegraphics[width=.95\textwidth]{RichardLeger.jpg}}
\end{minipage}
\hfill
...
\singlespacing
\Large{Trainer}\\
\huge{\textbf{Richard Leger}} \par
\flushright
\normalsize{\textit{\textrm{``Ich habe keine Zeit mich zu beeilen''}}}
\end{minipage}
%\end{figure}
...
\vspace{0pt}
\onehalfspacing
Fitness\\Radfahren\\Skifahren\\Berge
\end{minipage}
