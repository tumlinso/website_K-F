...
\vspace{0pt}
\fbox{\includegraphics[width=.95\textwidth]{TassiloFriedrich.jpg}}
\end{minipage}
\hfill
\begin{minipage}[t]{0.6\textwidth}
\vspace{0pt}
\singlespacing
\Large{Trainer, Jugendleiter}\\
\huge{\textbf{Tassilo Friedrich}} \par
\flushright
\normalsize{\textit{\textrm{``Keep On Moving''}}}
\end{minipage}
%\end{figure}
